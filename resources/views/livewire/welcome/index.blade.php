    ...
    <div class="flex c4ijw">
        <div class="c3ff8">
            <div class="cbz56 flex flex-col justify-center items-center">
                <img class="w-[10rem]" src="/backend/images/logo_default.svg">
                <div class="chc0j c9r0z caadu w-full">
                    <div class="ca831 cofxq c3ff8">
                        <div class="c4ijw">
                            ...
                            <ul class="flex cmgwo c4ijw c3ff8" x-data="{step: {{ $step }} } ">
                                <li>
                                    <div
                ...
                <div class="flex cmca2 c7ie4 c3hpn cwjye chmlm cofxq">
                    @if($step == 1)
                        <div class="cofxq">
                            <div class="mb-10">
                    ...
                    @if($step == 2)
                        <div class="cofxq">
                            <div class="mb-10">
                                ...
                                <p>
                                    Сейчас нужно указать данные для подключения к БД и запустить миграции (наполнение БД).<br>
                            ...
                            <form wire:submit="step2" wire:loading.remove x-data="{typeSQL: 'mysql'}">
                                <div class="mb-4">
                                    ...
                                    <select x-model="typeSQL" wire:model="dbdata.db_connection" id="dbdata.db_connection" class="cy9mt w-full">
                                ...
                                <div x-show="typeSQL != 'sqlite'">
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="mb-4">
                                            <label class="block text-sm cw92y ci4cg" for="dbdata.db_host">IP базы данных/сокет</label>
                                            <input id="dbdata.db_host" wire:model="dbdata.db_host" class="c03gb c3ff8 w-full"
                                        ...
                                        <div class="mb-4">
                                            <label class="block text-sm cw92y ci4cg" for="dbdata.db_port">Порт базы данных</label>
                                            <input id="dbdata.db_port" wire:model="dbdata.db_port" class="c03gb c3ff8 w-full"
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm cw92y ci4cg" for="dbdata.db_database">Название базы данных</label>
                                        <input id="dbdata.db_database" wire:model="dbdata.db_database" class="c03gb c3ff8 w-full"
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="mb-4">
                                            <label class="block text-sm cw92y ci4cg" for="dbdata.db_username">Имя пользователя</label>
                                            <input id="dbdata.db_username" wire:model="dbdata.db_username" class="c03gb c3ff8 w-full"
                                        ...
                                        <div class="mb-4">
                                            <label class="block text-sm cw92y ci4cg" for="dbdata.db_password">Пароль к БД</label>
                                            <input id="dbdata.db_password" wire:model="dbdata.db_password" class="c03gb c3ff8 w-full"
