    ...
    <div class="cewy4 clpyc cj3hv cofxq c3ff8 c9r0z c0ycj">
        <div class="ce97l">
            ...
            <div class="text-gray-400 text-sm">
                <i>Классы</i> - это разделы логики. У каждого класса могут быть свои объекты (устройства), методы и
                свойства.
                Сам по себе, класс не реализует логику, он лишь группирует ее.
            </div>
        </div>
                    ...
                    <div class="c9lun cju5y c5va1">
                        ...
                        <div>
                            <div>
                                ...
                                <select @disabled(count($this->availableClasses) == 0) wire:model.live="data.parent_id"
                                        class="cy9mt w-full">
                                    ...
                                    @empty
                                        <option value="0">Нет доступных классов</option>
                                    @endforelse
                                </select>
                ...
                <div class="text-center">
                    @if($data['id'])
                        <button type="submit" class="btn cfeqx !bg-green-700 ceqwg">
                            ...
                            <span class="c9o7o">Изменить класс</span>
                        </button>
                    @else
                        <button type="submit" class="btn cfeqx !bg-green-700 ceqwg">
                            ...
                            <span class="c9o7o">Создать класс</span>
                        </button>
                    @endif
                </div>
            </form>
