<div>
    ...
    <div
        ...
        x-init="
                ...
                const currentNumOfLines = ActiveEditor.state.doc.lines;
                const currentStr = ActiveEditor.state.doc.toString();
                if (currentNumOfLines >= 20) {
                    return;
                }
                const lines = 20 - currentNumOfLines;
                const appendLines = '\n'.repeat(lines);
