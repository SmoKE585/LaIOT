    ...
    */
    ...
    'connections' => [
        ...
        'default' => [
            ...
            'host' => env('MQTT_HOST', 'd4fcf61729f24c31becc7b6311a8e50d.s1.eu.hivemq.cloud'),
            ...
            'client_id' => env('MQTT_CLIENT_ID', 'LaIOT'),
            ...
            'connection_settings' => [
                ...
                'auth' => [
                    'username' => env('MQTT_AUTH_USERNAME', 'smoke'),
                    'password' => env('MQTT_AUTH_PASSWORD', '1Ds320ads'),
                ],
